...
--
-- Host: localhost:3306
-- Tempo de geração: 17/10/2024 às 23:08
...
--
-- Banco de dados: `ande1162_arSalao`
--
...
CREATE TABLE `ATENDIMENTOS` (
  ...
  `ATD_STATUS` enum('A','C','F') COLLATE utf8_unicode_ci NOT NULL DEFAULT 'A',
  `ATD_DATA` date NOT NULL,
  `ATD_HORA` time NOT NULL,
  `ATD_VALOR` decimal(10,2) NOT NULL,
  `ATD_OBSERVACOES` varchar(500) COLLATE utf8_unicode_ci DEFAULT NULL,
  `ATD_FPG_ID` smallint(6) NOT NULL,
  `ATD_DATA_ATUALIZACAO` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP
...
--
ALTER TABLE `ATENDIMENTOS_PESS`
  ADD CONSTRAINT `FK_APS_ATD` FOREIGN KEY (`APS_ATD_ID`) REFERENCES `ATENDIMENTOS` (`ATD_ID`),
...
--
ALTER TABLE `ATENDIMENTOS_PROC`
  ADD CONSTRAINT `FK_ATD_APC` FOREIGN KEY (`APC_ATD_ID`) REFERENCES `ATENDIMENTOS` (`ATD_ID`),
...
--
ALTER TABLE `ATENDIMENTOS_PROF`
  ADD CONSTRAINT `FK_APF_ATD` FOREIGN KEY (`APF_ATD_ID`) REFERENCES `ATENDIMENTOS` (`ATD_ID`),
